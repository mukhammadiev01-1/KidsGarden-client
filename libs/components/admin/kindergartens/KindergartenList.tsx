...
interface KindergartenPanelListType {
								...
								return (
									<TableRow hover key={kindergarten?._id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
										...
										<TableCell align="center">
											{formatMonthlyFee(kindergarten.monthlyFee ?? kindergarten.kindergartenPrice)}
										</TableCell>
