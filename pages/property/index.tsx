...
export const getServerSideProps: GetServerSideProps = async ({ query, locale, defaultLocale }) => ({
	redirect: {
		destination: buildRedirectDestination('/kindergartens', query, locale, defaultLocale),
		permanent: false,
	},
});

const KindergartensCompatibilityRedirect: NextPage = () => null;

export default KindergartensCompatibilityRedirect;
